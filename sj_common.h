...
public:
	...
	****************************************/
	...
	ofxGuiGroup Group_ArtSin3D;
		ofxToggle b_Draw_ArtSin3D_Quads;
		ofxToggle b_Draw_ArtSin3D_Points;
		ofxToggle b_ArtSin3D_DrawMode_Add;
		ofxColorSlider col_ArtSin3D;
		ofxToggle b_ArtSin3D_EnableDepthTest;
		ofxFloatSlider ArtSin3D_BarHeight;
		ofxFloatSlider ArtSin3D_BarSpace;
		ofxFloatSlider ArtSin3D_BarWidth;
		ofxFloatSlider ArtSin3D_PointSize;
		ofxFloatSlider ArtSin3D_NumDraw;
		ofxToggle b_Draw_ArtSin3D_Mirror;
		
	ofxGuiGroup Group_ArtSin2D;
		ofxToggle b_Draw_ArtSin2D;
		ofxVec2Slider ArtSin2D_Graph_ofs;
		ofxFloatSlider ArtSin2D_BarHeight;
		ofxColorSlider col_ArtSin2D;
		
	ofxGuiGroup Group_Lissajous;
		ofxToggle b_DrawLissajous;
