...
void ofApp::setup(){
	...
	********************/
	...
	DrawArtSin_3D.setup(fft_thread);
...
void ofApp::update(){
	...
	********************/
	...
	DrawArtSin_3D.update(fft_thread);
...
void ofApp::draw(){
	...
	********************/
	...
	DrawFFT.draw(fbo);
	if(Gui_Global->b_DrawLissajous)	DrawLissajous.draw(fbo);
	if(Gui_Global->b_Draw_ArtSin2D)DrawArtSin.draw(fbo);
	DrawArtSin_3D.draw(fbo, camera);
	DrawImg.draw(fbo);
